...
class UserAchievementFragment : Fragment() {
    ...
    private val viewModel: UserAchievementViewModel by lazy {
        ViewModelProviders.of(this).get(UserAchievementViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.user_achievement_fragment, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        userAchievementRecycler.layoutManager = LinearLayoutManager(context)
        userAchievementRecycler.adapter = achievementAdapter

        viewModel.achievements.nonNull().observe(this){
